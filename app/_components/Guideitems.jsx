...
const Guideitems = ({element}) => {
  return (
    <div data-aos="fade-up" className='flex flex-col items-center shadow-xl border-2 rounded-lg border-gray-400 bg-white p-7 cursor-pointer duration-300 hover:scale-105 gap-3'>
