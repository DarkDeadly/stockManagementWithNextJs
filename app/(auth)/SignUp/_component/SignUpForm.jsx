...
const SignUpForm = () => {
  return (
      ...
      <form action="" className="flex flex-col gap-3  p-5">
        ...
        <Button className={"p-6 text-center text-lg bg-[#2563EB] cursor-pointer"}>Sign Up</Button>
        <div className="flex items-center text-center">
          ...
          <hr className="flex-grow border-t border-gray-300" />
            ...
            <p className="text-center text-lg max-[524px]:text-[15px]" >You have an account? <span className="text-[#2563EB] underline cursor-pointer hover:text-purple-500 " >Sign In</span></p>
