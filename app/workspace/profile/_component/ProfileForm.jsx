    ...
    <div className="w-[95%] rounded-xl bg-white p-4">
      ...
      <div>
        {AuthUser?.username && (
          <div className="flex flex-col gap-3 py-3">
            <div className="flex justify-between">
              ...
              >
                {editUsernameToggle ? "edit" : "undo"}
              </p>
            </div>
            <Input
              placeholder={AuthUser.username}
              disabled={editUsernameToggle}
              className={"py-6"}
        ...
        {AuthUser?.email && (
          <div className="flex flex-col gap-3 py-3">
            <div className="flex justify-between">
              ...
              >
                {editEmailToggle ? "edit" : "undo"}
              </p>
            </div>
            <Input
              placeholder={AuthUser.email}
              disabled={editEmailToggle}
              className={"py-6"}
              name="profileEmail"
              onChange={onChangeHandle}
            />
        ...
        {AuthUser?.email && (
          <div className="flex flex-col gap-3">
            <div className="flex justify-between">
              ...
              >
                {editPasswordToggle ? "edit" : "undo"}
              </p>
            </div>
            <Input
              disabled={editPasswordToggle}
        ...
        <div className="flex gap-2 pt-3">
          <Button className={"cursor-pointer p-5"} onClick={onSubmitHandle}>
            Submit
          </Button>
          <Button className={"cursor-pointer bg-red-500 p-5 hover:bg-red-400"}>
            Delete
          </Button>
        </div>
      </div>
